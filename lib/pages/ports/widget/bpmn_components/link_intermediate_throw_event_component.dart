...
class LinkIntermediateThrowEventComponent extends StatelessWidget {
  static const String name = 'linkIntermediateThrowEvent';
  final ComponentData componentData;

  const LinkIntermediateThrowEventComponent({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return ElementWithOptionsWidget(
      ...
      child: BaseComponentBody(
        componentData: componentData,
        hidedText: true,
        componentPainter: LinkIntermediateThrowEventPainter(
...
class LinkIntermediateThrowEventPainter extends CustomPainter {
  Color _color;
  ...
  LinkIntermediateThrowEventPainter({
