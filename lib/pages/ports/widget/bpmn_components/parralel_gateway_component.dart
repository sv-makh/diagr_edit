...
class ParallelGatewayComponent extends StatelessWidget {
  static const String name = 'parallelGateway';
  final ComponentData componentData;

  const ParallelGatewayComponent({
    Key? key,
      ...
      child: Stack(
        ...
        children: [
          BaseComponentBody(
            componentData: componentData,
            hidedText: true,
            componentPainter: ParallelGatewayPainter(
...
class ParallelGatewayPainter extends CustomPainter {
  final Color _color;
  final Color _borderColor;
  final double _borderWidth;
  late Size _componentSize;

  ParallelGatewayPainter({
    Color? color,
    Color? borderColor,
    double? borderWidth,
