...
class StartEventComponent extends StatelessWidget {
  static const String name = 'startEvent';
  final ComponentData componentData;

  const StartEventComponent({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return ElementWithOptionsWidget(
      ...
      child: BaseComponentBody(
        componentData: componentData,
        //hidedText: true,
        componentPainter: StartEventPainter(
...
class StartEventPainter extends CustomPainter {
  final Color _color;
